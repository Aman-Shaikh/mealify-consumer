...
class FirestoreServices{
  ...
  static getProducts(category){
    return firestore.collection("Meals").where('p_subcategory',isEqualTo:category).snapshots();
  }
  ...
  static getWishlists(){
    return firestore.collection(mealsCollection).where('p_wishlist',arrayContains:FirebaseAuth.instance.currentUser!.uid).snapshots();
  }
  ...
  static getCount() async {
    var res= await Future.wait([
      ...
      firestore.collection(mealsCollection).where('p_wishlist',arrayContains:FirebaseAuth.instance.currentUser!.uid).get().then(
              (value) {
            return value.docs.length;
          }),
  ...
  static allProducts(){
     return firestore.collection(mealsCollection).snapshots();
  }
}